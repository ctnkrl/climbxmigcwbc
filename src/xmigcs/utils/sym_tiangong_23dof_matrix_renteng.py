...
class sym_tiangong_23dof_matrix_renteng_numpy(sym_tiangong_23dof_matrix_numpy):
    def __init__(self):
...
if __name__ == "__main__":
    s1 = sym_tiangong_23dof_matrix_renteng_numpy()
    num_envs = 1000

    num_dofs = 23
    num_policy_obs = 9 + 3 * num_dofs + 1
    history_length = 10
