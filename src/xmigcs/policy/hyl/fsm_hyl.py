...
class FSMStateHYL(FSMState):
    default_config_name = "hyl.yaml"
    ...
    def _play_remote_audio_HYL(self):
        ...
        command = "aplay ~/Documents/HYL.wav"
    ...
    def on_enter(self):
        ...
        #     threading.Thread(target=self._play_remote_audio_HYL).start()
    ...
    def inner_run(self):
        ...
        # update motion phase
        self.counter_step += 1
        if self.motion_length is not None and self.counter_step >= self.motion_length:
