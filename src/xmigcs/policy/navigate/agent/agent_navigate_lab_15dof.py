...
class agent_navigate_lab_15dof(agent_navigate_lab_12dof):
    def __init__(self):
        self.num_actions = 15
        self.prop_obs_history_len = 10
        self.num_prop_obs = 55

        self.dt = 0.01
        self.decimation = 1

        policy_path = osp.join(MODEL_DIR, "Dex_navigate_15dof_amp_sym_20260517_134251_model_48000.onnx")
