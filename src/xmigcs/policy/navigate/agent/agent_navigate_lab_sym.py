...
import numpy as np
from xmigcs.utils.sym_tiangong_23dof_matrix_numpy_navigate import sym_tiangong_23dof_matrix_numpy_navigate
from xmigcs.policy.navigate.agent.agent_navigate_lab import agent_navigate_lab
from xmigcs.utils.logging_utils import get_logger
logger = get_logger(__name__)

class agent_navigate_lab_sym(agent_navigate_lab):
    def __init__(self):
        super().__init__()
        self.inference_count = 0
        self.symmetry_module = sym_tiangong_23dof_matrix_numpy_navigate()
