...
from xmigcs.policy.navigate.agent import agent_navigate_lab_12dof_v2
from xmigcs.utils.logging_utils import get_logger
logger = get_logger(__name__)

class agent_navigate_lab_15dof_v2(agent_navigate_lab_12dof_v2):
    "有ref_ang_vel和endless_flag的版本"
    def __init__(self):
        self.num_actions = 15
        self.prop_obs_history_len = 10
        self.num_prop_obs = 57

        self.dt = 0.01
        self.decimation = 1

        policy_path = osp.join(MODEL_DIR, "Dex_navigate_15dof_amp_sym_20260602_120229_nav_f11_fixed_curriculum_model_69999.onnx")  # 启动时抖一下 精度还行 步态还行
        # policy_path = osp.join(MODEL_DIR, "Dex_navigate_15dof_amp_sym_20260602_230729_nav_f11d_model_30000.onnx")  # 启动不抖 置零后角度追踪会变差很多
