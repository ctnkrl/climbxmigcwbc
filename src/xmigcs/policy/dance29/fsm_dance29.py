...
class FSMStateDANCE29(FSMState):
    def __init__(self, robot_data: RobotData, config_path: Optional[str] = None, variant_name: str = "default"):
        ...
        config_path = os.path.join(current_dir, "config", "dance29.yaml")
    ...
    def inner_run(self):
        ...
        # 按 locked_joint_map 选取策略控制的关节（29dof 为全部关节）
