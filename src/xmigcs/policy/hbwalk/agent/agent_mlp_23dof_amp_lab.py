...
class agent_mlp_23dof_amp_lab:
    def __init__(self):
        self.num_actions = 23
        self.prop_obs_history_len = 10
        self.num_prop_obs = 78

        self.dt = 0.01
        self.decimation = 1

        policy_path = osp.join(MODEL_DIR, "Dex_walk_23dof_amp_sym_20260605_105110_baseline_model_49999.onnx")
    ...
    def inference(self, obs_group):
        ...
        input_feed = {
            "obs": prop_obs_history.flatten()[None, :].astype(np.float32),
        }
