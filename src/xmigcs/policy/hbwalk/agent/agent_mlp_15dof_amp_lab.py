...
class agent_mlp_15dof_amp_lab(agent_mlp_23dof_amp_lab):
    def __init__(self):
        self.num_actions = 15
        self.prop_obs_history_len = 10
        self.num_prop_obs = 54

        self.dt = 0.01
        self.decimation = 1

        # policy_path = osp.join(MODEL_DIR, "Dex_walk_15dof_amp_sym_20260624_123635_baseline_new_urdf_model_54000.onnx")
        policy_path = osp.join(MODEL_DIR, "Dex_walk_15dof_with_arms_amp_sym_20260626_155657_add_arm_rand_model_103750.onnx")
