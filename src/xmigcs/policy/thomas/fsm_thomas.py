...
class FSMStateTHOMAS(FSMState):
    def __init__(self, robot_data: RobotData, config_path: Optional[str] = None, variant_name: str = "default"):
        ...
        config_path = os.path.join(current_dir, "config", "thomas.yaml")
    ...
    def on_enter(self):
        ...
        self.counter_step = 0
        self._warmup_inference_counter = 0
        logger.info(f"[FSMStateTHOMAS], config={self.config_path}")
    ...
    def inner_run(self):
        ...
        target_dof_pos_mj_23dof = np.zeros(29)
